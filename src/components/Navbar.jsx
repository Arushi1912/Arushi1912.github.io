...
const Navbar = () => {
  ...
  const socialLinks = [
    {
      icon: Linkedin,
      url: "https://linkedin.com/in/arushinigam",
      label: "LinkedIn",
    },
    ...
    <nav className="fixed top-0 left-0 right-0 z-50 bg-beige/95 backdrop-blur-sm border-b border-gold-muted/30">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          <Link
            to="/"
            className="font-semibold text-lg text-slate hover:text-slate-blue transition-colors"
          >
            Arushi Nigam
          </Link>
              ...
              {socialLinks.map((social) => {
                ...
                return (
                  <a
                    ...
                    className="text-slate/60 hover:text-gold active:text-gold transition-colors"
